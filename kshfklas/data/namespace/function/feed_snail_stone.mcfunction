...
execute if data storage namespace:temp {random_roll:1} as @n[type=minecraft:wandering_trader,tag=namespace.snail,tag=!namespace.tamed] at @s run function namespace:tame
