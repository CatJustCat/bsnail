...
execute if data storage bsnail:temp {random_roll:1} as @n[type=minecraft:wandering_trader,tag=bsnail.snail,tag=!bsnail.tamed,distance=..4] at @s run function bsnail:tame
...
execute if entity @n[type=minecraft:wandering_trader,tag=bsnail.snail,tag=bsnail.tamed,distance=..4] run clear @s minecraft:oak_leaves 1
